...
class Task2_Lab2 extends Module {
    ...
    val mux1 = MuxCase(false.B , Array(
        ...
        (io.sel(1)+io.sel(0) === 2.U) -> io.in(2.U),
    ...
    val mux2 = MuxCase(false.B , Array(
        ...
        (io.sel(1)+io.sel(0) === 2.U) -> io.in(3.U),
        (io.sel(1)+io.sel(1) === 3.U) -> Mux(io.shift_type === 1.U , io.in(0.U) << 1.U , io.in(0.U) >> 1.U)
        // (io.sel(1)+io.sel(1) === 3.U) -> io.in(3.U)
    ))

    val mux3 = MuxCase(false.B , Array(
        (io.sel(0)+io.sel(0) === 0.U) -> io.in(2.U),
        (io.sel(0)+io.sel(1) === 1.U) -> io.in(3.U),
        (io.sel(1)+io.sel(0) === 2.U) -> Mux(io.shift_type === 1.U , io.in(0.U) << 1.U , io.in(0.U) >> 1.U),
    ...
    val mux4 = MuxCase(false.B , Array(
        ...
        (io.sel(0)+io.sel(1) === 1.U) -> Mux(io.shift_type === 1.U , io.in(0.U) << 1.U , io.in(0.U) >> 1.U),
        (io.sel(1)+io.sel(0) === 2.U) -> Mux(io.shift_type === 1.U , io.in(1.U) << 1.U , io.in(1.U) >> 1.U),
